...
public class AuditingDatabaseBatchIntegrationTest {
	...
	public void findById() throws Exception {
		transactionCaller.call(new Callable() {
			...
			public Object call() throws Exception {
				...
				Reader reader = new InputStreamReader(getClass().getResourceAsStream("./import.sql"));
				String[] sqls = extractor.extractCommands(reader);
